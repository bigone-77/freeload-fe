      ...
      <section className="flex items-start gap-4 my-4 ">
        ...
        <div className="flex flex-col gap-6">
          ...
          <span className="inline-block">
            ...
            receiptData.creditDate.split('/')[0].length !== 4 ? (
              <input
                className="p-2 border-2 rounded-lg shadow-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:outline-none transition duration-200 ease-in-out whitespace-nowrap hover:shadow-md"
                type="date"
                value={date}
