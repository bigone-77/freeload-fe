...
export default function BottomTab({ highwayInfo, direction }: IBottomTabProps) {
  ...
  return (
    <footer
      className={`
    ${goUp ? 'h-[80%]' : 'h-32'}
      absolute bottom-0 left-0 right-0 z-10 py-3 px-6 bg-text50 rounded-tl-[20px] rounded-tr-[20px] opacity-95 transition-all transform duration-1000 shadow-2xl`}
    >
